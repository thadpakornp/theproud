...
<html lang="en" class="ie9 no-js"> <![endif]-->
    ...
    <head>
        ...
        <title>ระเบียนผู้เข้าพัก | THE PROUD RESIDENCE</title>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        <div class="caption font-dark">
                                                            <i class="font-dark"></i>
                                                            <span class="caption-subject bold uppercase">ระเบียนผู้เข้าพัก</span>
                                                        </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rowreport['contract_idcard'] ?></td>
                                                                    <td><?php echo $rowreport['contract_name'] ?></td>
                                                                    <td><?php echo $rowreport['contract_address'] ?></td>
                                                                    <td><?php echo $rowreport['contract_phone'] ?></td>
                                                                </tr>
                                                                <?php
                                                               $sqlreport1 = "SELECT * FROM tbl_members WHERE contractid = '".$rowreport['contract_id']."' ORDER BY id ASC";
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $rowreport['contract_room'] ?></td>
                                                                    <td><?php echo $rowreport1['cardid'] ?></td>
                                                                    <td><?php echo $rowreport1['flname'] ?></td>
                                                                    <td><?php echo $rowreport1['address'] ?></td>
                                                                    <td><?php echo $rowreport1['phone'] ?></td>
                                                                </tr>
                                                                <?php } } ?>
                                                            </tbody>
                                                        </table>
