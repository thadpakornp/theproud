...
$sql = "SELECT * FROM tbl_reserve WHERE reserve_id = '".$cid."' OR reserve_idcard = '".$cid."'";
                                ...
                                <div class="container">
                                    ...
                                    <div class="portlet box yellow">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>ทำสัญญาการจองเลขที่
                                                <?php echo $row['reserve_id'] ?> [กรุณาระบุข้อมูลตามรูปแบบที่กำหนด]</div>
                                        </div>
                                        <div class="portlet-body form">
                                            <!-- BEGIN FORM-->
                                            <form action="contract_have_reserve_3.php?cid=<?php echo $_GET['cid'] ?>" class="form-horizontal" method="post">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="Fristname and Lastname" name="youname" required value="<?php echo $row['reserve_name'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="ID Card" name="idcard" required value="<?php echo $row['reserve_idcard'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="Phone" required name="phone" value="<?php echo $row['reserve_phone'] ?>" maxlength="12">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="<?php echo date("d-m-Y") ?>" required value="<?php echo date("d-m-Y") ?>" readonly>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="Room" name="room" required value="<?php echo $row['reserve_room'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" placeholder="Floor" name="floor" required value="<?php echo $row['reserve_floor'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" name="address" required value="<?php echo $row['reserve_address'] ?>"> </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="roomprice" value="<?php echo $row['reserve_price'] ?>">
