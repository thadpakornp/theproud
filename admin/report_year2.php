...
<html lang="en" class="ie9 no-js"> <![endif]-->
    ...
    <head>
        ...
        <title>รายรับประจำปี <?php echo $dateyear ?> | THE PROUD RESIDENCE</title>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        <div class="caption font-dark">
                                                            <i class="font-dark"></i>
                                                            <span class="caption-subject bold uppercase">รายรับประจำปี <?php echo $dateyear ?></span>
                                                        </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                            ...
                                                            $sql0 = "SELECT DISTINCT month1 FROM tbl_payment WHERE year1 = '".$_POST['y']."'";
                                                            $result0 = mysqli_query($conn,$sql0);
                                                            while($row0 = mysqli_fetch_array($result0)){

                                                            $sqlreport = "SELECT * FROM tbl_payment WHERE month1 = '".$row0['month1']."'";
                                                            ...
                                                            while($rowreport = mysqli_fetch_array($resultreport)){
                                                                ...
                                                                if($lenref > 10){
                                                                    ...
                                                                    if(mysqli_num_rows($result3)<1){
                                                                        ...
                                                                        $sumwater += $unitwater*$pricewater;
                                                                        $sumelec += $unitelec*$priceelec;
                                                                    }
                                                                    $sumother += $rowservice['service_price']+$rowservice1['service_price']+$rowservice2['service_price'];
                                                                    ...
                                                                    $sumwater += 0;
                                                                    $sumelec += 0;
                                                                    $sumother += $rowservice['service_price']+$rowservice2['service_price'];
                                                                }
                                                            }
                                                            $n = explode("-",$row0['month1']);
                                                            $thaimonth=array("มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม");
	                                                        $datemonth = $thaimonth[$n[0]-1];
	                                                        $dateyear = $n[1]+543;
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo $datemonth." ".$dateyear ?></td>
                                                                    <td><?php echo $sumrent?></td>
                                                                    <td><?php echo $sumelec?></td>
                                                                    <td><?php echo $sumwater?></td>
                                                                    <td><?php echo $sumother?></td>
                                                                    <td><?php echo $sumrent+$sumelec+$sumwater+$sumother ?></td>
                                                                </tr>
                                                             <?php 
                                                              $sumallsum1 += $sumrent;
                                                            $sumallsum2 += $sumelec;
                                                            $sumallsum3 += $sumwater;
                                                            $sumallsum4 += $sumother;
                                                            $sumallsum5 += $sumrent+$sumelec+$sumwater+$sumother;
                                                             } ?>
                                                              <tr>
                                                            <td>รวม</td>
