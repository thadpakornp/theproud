                                    ...
                                    <!-- END PAGE BREADCRUMBS -->
                                                            ...
                                                            <div class="portlet box blue">
                                                                <div class="portlet-title">
                                                                    <div class="caption">
                                                                        <i class="fa fa-gift"></i>ทำสัญญาห้องพัก <?php echo $_POST['room'] ?> </div>
                                                                </div>
                                                                <div class="portlet-body form">
                                                                    <!-- BEGIN FORM-->
                                                                     <form class="form-horizontal" role="form" action="cmd.php?action=confirmcontract1" method="post">
                                                                        <div class="form-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <p class="form-control-static"><strong> <?php echo $_POST['room'] ?> </strong></p>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <p class="form-control-static"><strong> <?php echo $_POST['floor'] ?> </strong></p>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <p class="form-control-static"><strong> <?php if($_POST['remask']!="")echo "ลายนิ้วมือ ".$_POST['remask']; ?>    <?php if($_POST['remask1']!="")echo "ทะเบียนรถ ".$_POST['remask1']; ?>     <?php if($_POST['remask2']!="")echo "รหัส ".$_POST['remask2']; ?> 
																							</strong></p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-offset-6 col-md-12">
                                                                                 <input type="hidden" name="phone" value="<?php echo $_POST['phone'] ?>">					
                                                                        			<input type ="hidden" name="reserve_number" value="<?php echo $_GET['cid'] ?>">
