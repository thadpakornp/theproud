...
<html lang="en" class="ie9 no-js"> <![endif]-->
    ...
    <head>
        ...
        <title>ทะเบียนยานพาหนะ | THE PROUD RESIDENCE</title>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        <div class="caption font-dark">
                                                            <i class="font-dark"></i>
                                                            <span class="caption-subject bold uppercase">ทะเบียนยานพาหนะ</span>
                                                        </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rowreport['contract_remark1'] ?></td>
