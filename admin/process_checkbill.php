                                    ...
                                    <!-- END PAGE BREADCRUMBS -->
                                                            ...
                                                            <div class="portlet box purple">
                                                                <div class="portlet-title">
                                                                    <div class="caption">
                                                                        <i class="fa fa-gift"></i>กรุณาเลือกโปรแกรมการทำรายการ</div>
                                                                </div>
                                                                <div class="portlet-body form">
                                                                    <!-- BEGIN FORM-->
                                                                    <form action="process_bill.php" class="form-horizontal" method="post">
                                                                           ...
                                                                           <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <div class="form-group">
                                                                    									<label class="control-label col-md-2">ประเภทการชำระเงิน
                                                                        								<span class="required"> * </span>
                                                                   									 </label>
                                                                    									<div class="col-md-9">
                                                                       									 <select class="form-control" name="select1">
                                                                            									<option value="no" selected>โปรดระบุประเภท...</option>
                                                                            									<option value="1">ค่าเช่าประจำเดือน</option>
                                                                            									<option value="2">ค่าทำสัญญา/ใบจอง</option>
                                                                        								</select>
                                                                    									</div>
                                                                									</div>
                                                                                    </div>
