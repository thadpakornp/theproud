                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <form action="cmd.php?action=uploadcontract" method="post" enctype="multipart/form-data">
                                    <p>รูปหน้า 1 
                                        <input name="img1" type="file" id="image_name" size="40" required accept="image/*"/>
                                    </p>
                                    <p align="center">
                                    ...
                                    <p align="center">
                                    อนุญาตไฟล์นามสกุล .jpg กับ .png เท่านั้น โปรดระวังชื่อไฟล์ซ้ำกัน
                                    </p>
                                    </form>
                                    <center>
                                    <a href="mobile.php?cid=<?php echo $_GET['cid'] ?>&name=<?php echo $_GET['name'] ?>&id=<?php echo $_GET['id'] ?>&phone=<?php echo $_GET['phone'] ?>">อัพโหลดผ่านมือถือ</a>
                                     </center>                       
                                </div>
                            </div>
