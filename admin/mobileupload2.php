...
$sql = "SELECT * FROM tbl_contract WHERE contract_id = '".$passkey."' AND contract_status = '0' AND ISNULL(img2)";
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <form action="cmd.php?action=uploadcontractpage2" method="post" enctype="multipart/form-data">
                                    <p>รูปหน้า 2 
