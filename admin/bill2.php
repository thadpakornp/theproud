                                        ...
                                        <div class="invoice">
                                            <div class="row invoice-logo">
                                                <div class="col-xs-4 invoice-logo-space">
                                                    <img src="../assets/pages/media/invoice/14975889_1134711006604817_1463979142_o.png" class="img-responsive" alt="" Width="200" height="83"/> </div>
                                                <div class="col-xs-8">
                                                    <address class="pull-right" align="right">
                                                            <strong>The Proud Residence.</strong>
                                                            <br/> 153 หมู่ 4 ตำบลโพไร่หวาน                                                            อำเภอเมือง จังหวัดเพชรบุรี 
                                                            76000 , ประเทศไทย
                                                            <br/> 0959829415,0946463563
                                                            <br/> <strong>ใบเสร็จรับเงิน/ต้นฉบับ</strong>
                                                            <br/> <strong><?php echo $_GET['pay'] ?></strong> 
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <table class="table table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                               <?php
    $sql00 = "SELECT * FROM tbl_contract WHERE contract_room = '".$_GET['room']."' AND contract_status = '0'";
...
$row = mysqli_fetch_array($result);
                                            ...
                                            ?>
                                            <tr>
                                                        <td width="85%">ได้รับเงินจาก <strong><?php echo $row00['contract_name'] ?></strong> ผู้เช่าห้องพักหมายเลขค่าเช่าห้องพัก <strong><?php echo $row00['contract_room'] ?></strong></td>
                                             ...
                                             <tr>
                                                ...
                                                <div class="col-xs-12 invoice-payment">
                                                    ...
                                                    <a class="btn btn-lg blue hidden-print margin-bottom-5" onclick="javascript:window.print();"> Print
                                                     ...
                                                     <a class="btn btn-lg blue hidden-print margin-bottom-5" href="http://<?php echo $_SERVER['REMOTE_ADDR'] ?>/wifi/admin/updateUserWifi.php?id=<?php echo $row00['contract_idcard'] ?>&d=<?php echo $row['usage_date'] ?>" target="_blank"> Finish. Update EXP Wi-Fi(Please connected with Local Network).
