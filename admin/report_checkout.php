...
<html lang="en" class="ie9 no-js"> <![endif]-->
    ...
    <head>
        ...
        <title>รายงานผู้ออกจากหอพัก | THE PROUD RESIDENCE</title>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        <div class="caption font-dark">
                                                            <i class="font-dark"></i>
                                                            <span class="caption-subject bold uppercase">รายงานผู้ออกจากหอพัก</span>
                                                        </div>
                                                        <div class="tools"> </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                            $sqlreport = "SELECT * FROM tbl_contract WHERE contract_status != '0' AND contract_status != '1' ORDER BY contract_room ASC";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    <td><?php echo $rowreport['contract_id'] ?></td>
