                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <tr>
                                                        ...
                                                        <td width="15%" align="center"><strong>เป็นเงิน</strong></td>
																										...
																										<tr>
																												 <td width="85%"><?php echo $_GET['roommsg'] ?></td>
																												 <td width="15%" align="right"><?php echo number_format($_GET['roomprice'],2)?></td>
																										 </tr>
																										<tr>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <?php
                                                        ...
                                                        <td width=\"15%\" align=\"right\">".number_format($_GET['priceother'],2)."</td>
                                                            ...
                                                            ?>
																														<tr>
																																 <td width="85%"><?php echo $_GET['msg'] ?></td>
																																 <td width="15%" align="right"></td>
																														 </tr>
																														<tr>
																																 <td width="85%"><?php echo $_GET['msgservice'] ?></td>
																																 <td width="15%" align="right"></td>
																														 </tr>
                                                            <tr>
                                                                <td width="85%"><center><strong><?php echo convert((($_GET['elec1']-$_GET['elec'])* $priceelec)+(($_GET['water1']-$_GET['water'])* $pricewater)+$_GET['clean']+$_GET['air']+$priceother+$_GET['msg1']+$_GET['seevice3']+$_GET['roomprice']) ?></strong></center></td>
                                                                <td width="15%" align="right"><?php echo number_format(((($_GET['elec1']-$_GET['elec'])* $priceelec)+(($_GET['water1']-$_GET['water'])* $pricewater)+$_GET['clean']+$_GET['air']+$priceother+$_GET['msg1']+$_GET['seevice3']+$_GET['roomprice']),2) ?></td>
                                                            </tr>
                                                </table>
