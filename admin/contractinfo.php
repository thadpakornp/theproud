                                ...
                                <div class="container">
                                    ...
                                    <center> <?php
                                                $generator = new \Picqer\Barcode\BarcodeGeneratorPNG();
                                                 echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($_GET['id'], $generator::TYPE_CODE_39)) . '">';
                                                ?></center>
...
$userphone = $row['contract_phone'];
    echo "<a class=\"btn btn-lg blue hidden-print margin-bottom-5\" onclick=\"window.open('upload.php?cid=$_GET[cid]&name=$username&id=$userid&phone=$userphone', '_blank', 'location=yes,height=300,width=500,scrollbars=yes,status=yes');\"> Upload
