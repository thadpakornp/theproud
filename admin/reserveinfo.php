...
$sql = "SELECT * FROM tbl_reserve WHERE reserve_id = '".$_GET['id']."'";
                                    ...
                                    <div class="page-content-inner">
                                        <div class="invoice">
                                            <div class="row invoice-logo">
                                                ...
                                                <div class="col-xs-6">
                                                    <p> สำเนาใบสำคัญการจองห้องพัก
                                                    <?php echo $row['reserve_id'] ?>
                                                       <span class="muted"> <?php echo $row['reserve_date'] ?> </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 invoice-block">
                                                    <ul class="list-unstyled amounts">
                                                        <li>
                                                            <strong>Amount:</strong> <?php echo $row['reserve_price'] ?>฿ </li>
                                                        <li>
                                                            <strong>Discount:</strong> --------- </li>
                                                        <li>
                                                            <strong>VAT:</strong> --------- </li>
                                                        <li>
                                                            <strong>Total:</strong> <?php echo $row['reserve_price'] ?>฿ </li>
                                                    </ul>
